...
def draw_fill_rectangle(begX, begY, width, height):
    SDL_SetRenderDrawColor(renderer, 102, 37, 0, 255)
    rect = SDL_Rect(begX, begY+canvas_height, width, -height)
    SDL_RenderFillRect(renderer, rect)


def drawLine(begX, begY, endX, endY, r, g, b):
   SDL_SetRenderDrawColor(renderer, r, g, b, 1)
   SDL_RenderDrawLine(renderer,begX, canvas_height-begY, endX, canvas_height-endY)
